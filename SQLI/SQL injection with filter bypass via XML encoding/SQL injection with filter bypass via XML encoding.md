...
![[4.bmp]]![storeId=2 request and response showing 182 units](Img/4.jpg)

![storeId=1+1 request and response showing same 182 units](Img/5.jpg)
...
![Attack detected response from WAF](Img/6.jpg)
...
![Extracted usernames and passwords via Hackvertor encoding](Img/7.jpg)

- From there, I logged in using those credentials to complete the lab

![Successfully logged in as administrator](Img/8.jpg)
